...
/* 8 */
#define SWEEP_Y_MAX_OP8		2400
#define SWEEP_X_MAX_OP8		1080
#define SWEEP_EDGE_OP8		120
#define SWEEP_Y_LIMIT_OP8	SWEEP_Y_MAX_OP8-SWEEP_EDGE_OP8
#define SWEEP_X_LIMIT_OP8	SWEEP_X_MAX_OP8-SWEEP_EDGE_OP8
#define SWEEP_X_B1_OP8		350
#define SWEEP_X_B2_OP8		600
#define SWEEP_Y_START_OP8	800
#define SWEEP_X_START_OP8	530
#define SWEEP_X_FINAL_OP8	260
#define SWEEP_Y_NEXT_OP8	150
...
static int __init get_model(char *cmdline_model)
{
	if (strstr(cmdline_model, "19821")) {
		sweep_y_limit = SWEEP_Y_LIMIT_OP8;
		sweep_x_limit = SWEEP_X_LIMIT_OP8;
		sweep_x_b1 = SWEEP_X_B1_OP8;
		sweep_x_b2 = SWEEP_X_B2_OP8;
		sweep_y_start = SWEEP_Y_START_OP8;
		sweep_x_start = SWEEP_X_START_OP8;
		sweep_x_final = SWEEP_X_FINAL_OP8;
		sweep_y_next = SWEEP_Y_NEXT_OP8;
		sweep_x_max = SWEEP_X_MAX_OP8;
		sweep_edge = SWEEP_EDGE_OP8;
		hw_version = OP8;
	}
	return 0;
}
